...
<div class="about-container" style="max-width: 900px; margin: 0 auto;">
    ...
    <p>This project was developed for CPCS 403. Below is the developer's professional resume.</p>

    <div class="resume-wrapper" style="border: 1px solid #ccc; margin-top: 20px; height: 800px;">
